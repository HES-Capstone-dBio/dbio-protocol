...
- [GET /dbio/resources/claimed/\{subject-eth-address\}/\{resource-type\}/\{fhir-resource-id\}](#get-dbioresourcesclaimedsubject-eth-addressresource-typefhir-resource-id)
- [GET /dbio/resources/unclaimed/\{subject-eth-address\}/\{resource-type\}/\{fhir-resource-id\}](#get-dbioresourcesunclaimedsubject-eth-addressresource-typefhir-resource-id)
...
#### `GET /dbio/resources/claimed/{subject-eth-address}/{resource-type}/{fhir-resource-id}`
The get request to `/dbio/users/resources/claimed/{subject-eth-address}/{resource-type}/{resource-id}` takes as path parameters the following items:
- `subject-eth-address` - The Ethereum public address of the subject of the queried resource.
- `resource-type` - The type of the resource (correlates with a FHIR resource type).
...
#### `GET /dbio/resources/unclaimed/{subject-eth-address}/{resource-type}/{fhir-resource-id}`
The get request to `/dbio/users/resources/unclaimed/{subject-eth-address}/{resource-type}/{resource-id}` takes as path parameters the following items:
- `subject-eth-address` - The Ethereum public address of the subject of the queried resource.
- `resource-type` - The type of the resource (correlates with a FHIR resource type).
- `fhir-resource-id` - The FHIR resource ID of the resource for which to retrieve ciphertext for.
